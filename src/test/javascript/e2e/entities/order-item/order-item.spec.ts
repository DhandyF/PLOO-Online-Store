...
describe('OrderItem e2e test', () => {
    ...
    it('should load OrderItems', async () => {
        ...
        expect(await orderItemComponentsPage.getTitle()).to.eq('jhipsterApp.orderItem.home.title');
    });
    ...
    it('should load create OrderItem page', async () => {
        ...
        expect(await orderItemUpdatePage.getPageTitle()).to.eq('jhipsterApp.orderItem.home.createOrEditLabel');
    ...
    it('should delete last OrderItem', async () => {
        ...
        expect(await orderItemDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.orderItem.delete.question');
