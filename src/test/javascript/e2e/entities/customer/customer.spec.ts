...
describe('Customer e2e test', () => {
    ...
    it('should load Customers', async () => {
        ...
        expect(await customerComponentsPage.getTitle()).to.eq('jhipsterApp.customer.home.title');
    });
    ...
    it('should load create Customer page', async () => {
        ...
        expect(await customerUpdatePage.getPageTitle()).to.eq('jhipsterApp.customer.home.createOrEditLabel');
    ...
    it('should delete last Customer', async () => {
        ...
        expect(await customerDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.customer.delete.question');
