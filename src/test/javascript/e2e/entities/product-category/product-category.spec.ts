...
describe('ProductCategory e2e test', () => {
    ...
    it('should load ProductCategories', async () => {
        ...
        expect(await productCategoryComponentsPage.getTitle()).to.eq('jhipsterApp.productCategory.home.title');
    });
    ...
    it('should load create ProductCategory page', async () => {
        ...
        expect(await productCategoryUpdatePage.getPageTitle()).to.eq('jhipsterApp.productCategory.home.createOrEditLabel');
    ...
    it('should delete last ProductCategory', async () => {
        ...
        expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.productCategory.delete.question');
